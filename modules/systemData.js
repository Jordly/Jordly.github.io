  ...
  if(_systemDataView === 'catalog'){
    ...
    +'<div class="module-header">'
      ...
      +'<div style="display:flex;gap:8px;align-items:center;">'
        +'<button class="btn btn-xs" onclick="window._sdAllExpanded=true;_moduleCache[\'systemData\']=null;renderModule(\'systemData\')">展开全部</button>'
        +'<button class="btn btn-xs" onclick="window._sdAllExpanded=false;_moduleCache[\'systemData\']=null;renderModule(\'systemData\')">折叠全部</button>'
      +'</div>'
    +'</div>'
