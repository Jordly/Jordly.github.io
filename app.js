      ...
      <tbody>
        ${all.map(p=>`
          <tr>
            ...
            <td><span class="wp-tag wp-${p.workplace==='济南'?'jinan':p.workplace==='淄博'?'zibo':'hangzhou'}">${p.workplace}</span></td>
            <td>${p.pm}</td>
            <td style="color:${p.profitRate>=10?'var(--c-green)':p.profitRate<0?'var(--c-red)':'var(--c-yellow)'}">${p.profitRate}%</td>
            <td class="actions">
    ...
    <div class="project-detail-header">
      <div>
        ...
        <div class="project-detail-meta">
          <span class="wp-tag wp-${p.workplace==='济南'?'jinan':p.workplace==='淄博'?'zibo':'hangzhou'}">${p.workplace}职场</span>
