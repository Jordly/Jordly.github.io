...
var KNOWLEDGE_SEED_VERSION = '2026-08-enriched';

var DEFAULT_KNOWLEDGE = [

  {id:1, title:"团队人力成本优化模型", domain:"成本与核算", tags:"人力成本,排班,降本", projectId:"", scope:"通用", permission:"公开", fileUrl:"", createdAt:"2026-05-12", updateTime:"2026-08-11", views:286, downloads:52, description:"【适用场景】项目利润率下滑、人力成本占比过高时使用。\n\n【核心方法】\n1. 排班模型优化：用历史接待量分时数据反推各时段所需人力，避免忙时人不够、闲时人太多。\n2. 技能矩阵：团队按能力分级(A/B/C)，A级处理复杂问题、C级处理简单咨询，用分层路由把人力效率最大化。\n3. 多项目人力共享池：相邻项目间建立人员借调机制，淡旺季互补。\n\n【常见坑】只算人数不算技能结构导致降本后服务质量崩溃；共享池没提前和甲方沟通导致合规风险。\n\n【配套工具】分时人力预测Excel模板、技能矩阵自评表。\n\n【关联】要与BPO费效比分析一起看——自建降本和外包降本是两个不同逻辑。", short:"人力成本率系统性优化方法论", relatedIds:[7], sourceType:"manual", sourceId:"", version:2, versionHistory:[{version:2,time:"2026-08-11",summary:"内容扩充"}], status:"published"},

  {id:2, title:"AI客服工具选型与落地指南", domain:"效率与AI", tags:"AI,工具选型,落地,提效", projectId:"", scope:"通用", permission:"公开", fileUrl:"", createdAt:"2026-03-10", updateTime:"2026-08-11", views:341, downloads:88, description:"【适用场景】考虑引入AI客服工具(店小蜜/晓多等)，或已有工具但效果不理想时使用。\n\n【选型五维度】①解决率(目标>60%) ②转人工率(<40%) ③意图识别准确率(>85%) ④部署成本(年费+运维+培训) ⑤平台兼容性(淘宝/京东/拼多多/抖音是否支持)。\n\n【落地四步】\n1. 试点选中型项目，配置TOP20高频问题\n2. 运行2周对比人工组和AI组关键指标\n3. 建人机协同SOP：AI处理简单→复杂转人工→人工标记新意图→反哺AI\n4. 按ROI决策：AI月成本÷替代人工月成本<60%则推广\n\n【常见坑】以为买了工具就完事了——知识库配置至少1个月迭代；低价工具解决率低反而增加人工负担。", short:"AI工具选型与落地ROI框架", relatedIds:[8], sourceType:"manual", sourceId:"", version:2, versionHistory:[{version:2,time:"2026-08-11",summary:"内容扩充"}], status:"published"},

  {id:3, title:"跨项目经验快速复制SOP", domain:"流程与SOP", tags:"经验复制,标准化,知识沉淀", projectId:"", scope:"通用", permission:"公开", fileUrl:"", createdAt:"2026-02-18", updateTime:"2026-08-11", views:209, downloads:41, description:"【适用场景】某项目优秀做法(如降诉率话术、排班方案)推广到其他项目。\n\n【四步法】\n1. 经验萃取(1周)：跟优秀项目主管做1小时访谈，提炼具体做法和底层逻辑，写成1页纸\n2. 模板化改造(1周)：去掉原项目特有细节(品牌名、产品)，保留通用方法论\n3. 试点验证(2周)：新项目试用，收集反馈，标注水土不服处修改\n4. 规模推广(2周起)：发布正式版SOP，搭配培训，纳入质检体系\n\n【常见坑】直接复制不理解底层逻辑→换项目就失效；推广太快没试点→反对声音大推不下去。", short:"好经验跨项目复制四步法", relatedIds:[11], sourceType:"manual", sourceId:"", version:2, versionHistory:[{version:2,time:"2026-08-11",summary:"内容扩充"}], status:"published"},

  {id:4, title:"核心人员突发离职应急方案", domain:"风控与应急", tags:"人才风险,离职,应急,继任", projectId:"", scope:"通用", permission:"内部", fileUrl:"", createdAt:"2026-04-22", updateTime:"2026-08-11", views:174, downloads:33, description:"【适用场景】项目主管/组长/核心骨干突然提离职。\n\n【应急时间线】第1天：稳住情绪、了解真实原因(薪资/发展/人际关系)、评估挽留、启动B计划。第3天：确定离职日期、拉业务交接清单、指定临时负责人。第1周：完成基础交接(项目档案/在跟事项/甲方联系人/账号权限)、通知甲方。第2周：新负责人上手、老主管跟带1周。第4周：新负责人独立运作。\n\n【配套工具】关键岗位继任者名单(每主管须有1预备人选)；离职交接检查清单(7大类30项)；团队情绪维稳话术。\n\n【常见坑】没提前储备继任者→离职变危机；交接太匆忙漏甲方联系人→项目出问题。", short:"核心骨干突发离职应急响应", relatedIds:[6,10], sourceType:"manual", sourceId:"", version:2, versionHistory:[{version:2,time:"2026-08-11",summary:"内容扩充"}], status:"published"},

  {id:5, title:"难缠客户升级投诉应对话术", domain:"客诉与话术", tags:"投诉升级,沟通,话术,危机", projectId:"", scope:"通用", permission:"公开", fileUrl:"", createdAt:"2026-01-15", updateTime:"2026-08-11", views:378, downloads:71, description:"【适用场景】客户投诉升级到主管层面，涉及金额大或有舆论风险。\n\n【五步闭环】\n1. 情绪接纳(30秒)：肯定客户情绪、感谢反馈、不给结论\n2. 事实确认(3分钟)：让客户完整叙述、复述确认理解\n3. 责任界定：不要当场承诺赔偿！说需核实后明天回复具体方案\n4. 方案提出(1天)：内部讨论后给补偿方案，附免责声明\n5. 闭环跟进(3天)：执行后回访确认满意度，记录归档\n\n【常见坑】当场答应赔偿金额→对方录音后续要求更高；用公司规定来推脱→激化矛盾。永远说需要请示一下。", short:"升级投诉的高层级沟通框架", relatedIds:[], sourceType:"manual", sourceId:"", version:2, versionHistory:[{version:2,time:"2026-08-11",summary:"内容扩充"}], status:"published"},

  {id:6, title:"新任主管30天上手指南", domain:"培训与入门", tags:"新任主管,带团队,角色转换", projectId:"", scope:"通用", permission:"公开", fileUrl:"", createdAt:"2025-12-01", updateTime:"2026-08-11", views:452, downloads:96, description:"【适用场景】一线客服晋升主管、或外部招聘的新主管入职前30天。\n\n【四周计划】第1周-熟悉：看项目档案(客户是谁/历史KPI/团队人员)，跟客服坐一天岗。第2周-信任：跟每个组员做15分钟1v1(问：最大困难是什么？希望我帮你解决什么？)，不急改流程先观察。第3周-体系：选1个优先级最高的问题动手改(如排班不合理)，做第一份周报。第4周-结果：复盘修正方向，汇报进展，制定下月3个目标。\n\n【工具包】1v1面谈问题清单(10问)；新主管周报模板；角色转换避坑清单。\n\n【常见坑】一上来大改流程→老员工抵触；只盯KPI不看人→团队离心。", short:"一线到管理的30天转换地图", relatedIds:[10], sourceType:"manual", sourceId:"", version:2, versionHistory:[{version:2,time:"2026-08-11",summary:"内容扩充"}], status:"published"},

  {id:7, title:"BPO项目费效比分析方法", domain:"成本与核算", tags:"BPO,费效比,核算,外包", projectId:"", scope:"通用", permission:"公开", fileUrl:"", createdAt:"2026-05-28", updateTime:"2026-08-11", views:131, downloads:24, description:"【适用场景】评估外包项目是否划算、或对比多个BPO供应商。\n\n【核算公式】费效比=(BPO月费+我方管理成本)÷月处理工单量\n\n【拆解维度】1.显性成本：BPO报价(人头单价×人数)、平台费、培训费。2.隐性成本：我方管理人员投入(一个主管管3-5个BPO≈30%工时)、质检抽检、沟通协调、合规风险。3.对比基准：自建同等规模团队年成本÷12。\n\n【决策】BPO费效比<自建费效比×80%→外包划算；80%-120%→看质量稳定性；>120%→自建更优。\n\n【常见坑】只比人头单价忘管理成本→实际贵30%；BPO低价抢标后续加价→合同要锁价。", short:"外包客服费效比核算测算", relatedIds:[1], sourceType:"manual", sourceId:"", version:2, versionHistory:[{version:2,time:"2026-08-11",summary:"内容扩充"}], status:"published"},

  {id:8, title:"智能质检提效实践", domain:"效率与AI", tags:"质检,AI,自动化", projectId:"", scope:"通用", permission:"内部", fileUrl:"", createdAt:"2026-04-08", updateTime:"2026-08-11", views:223, downloads:47, description:"【适用场景】人工质检抽检率低(<5%)，想用AI实现全量质检。\n\n【实施路径】1.标准数字化(1周)：质检打分表逐条转AI可识别规则。2.系统部署(2周)：配置质检平台→导入历史→AI学习→人工校准。3.双轨运行(2周)：AI+人工同时质检同一批，对比差异，调AI规则直到准确率>90%。4.全量切换：人工抽检从100%降到5%(仅抽查AI低分项)。\n\n【效果】质检覆盖率5%→100%；人力节省60%-80%；问题发现周报→实时预警。\n\n【搭配】和AI客服工具选型一起看——质检AI和客服AI通常是同一平台两面。", short:"AI全量质检与整改闭环", relatedIds:[2], sourceType:"manual", sourceId:"", version:2, versionHistory:[{version:2,time:"2026-08-11",summary:"内容扩充"}], status:"published"},

  {id:9, title:"【活动预案】电商大促全流程准备指南", domain:"风控与应急", tags:"大促,双11,618,预案,排班,人力", projectId:"", scope:"通用", permission:"公开", fileUrl:"", createdAt:"2026-08-11", updateTime:"2026-08-11", views:0, downloads:0, description:"基于XCXD客服中心大促准备指导手册(2021版)整理。\n\n【7个阶段】T-90天启动准备→T-60天招聘培训→T-30天方案落地→T-14天精准备战→T-7天预演冲刺→T-1天就绪确认→D-Day爆发日全时值守。\n\n【19个维度】核心KPI | 人力预估招聘 | 班务安排(大促期) | 班务安排(爆发日) | 激励制度 | 营销排期 | 评价管控 | 风险订单 | 发货发票反查 | 价格优惠计算 | 培训逻辑 | AI分流 | 硬件设备 | 工位贴士 | 食品饮品 | 应急预案 | 质检安排 | 数据监控 | 刷单计划。\n\n每个维度含详细准备事项清单，可直接逐项核验。", short:"双11/618大促全流程备战指南", relatedIds:[4,10], sourceType:"manual", sourceId:"", version:1, versionHistory:[], status:"published"},

  {id:10, title:"多职场客服团队协同管理方法", domain:"人员管理", tags:"多职场,协同,远程管理", projectId:"", scope:"通用", permission:"公开", fileUrl:"", createdAt:"2026-08-11", updateTime:"2026-08-11", views:0, downloads:0, description:"【适用场景】管理分布不同城市200人团队，需统一标准又保留本地灵活性。\n\n【协同框架】1.统一标准层：全国统一质检标准、KPI考核、SOP流程、培训体系——中心制定各地执行。2.本地灵活层：排班方式(各地通勤习惯不同)、激励方案(生活成本不同)、招聘策略(当地人才差异)。3.信息同步机制：周一全员晨会(视频/10分钟/本周重点)；周三各地组长1v1(15分钟)；周五数据汇总(统一模板)。\n\n【管理工具】共享在线看板(实时看各地KPI)；轮岗计划(每年2人跨职场)；远程巡检(每月1次视频巡场)。\n\n【常见坑】只讲统一不讲弹性→各地反映总部不了解本地；信息同步靠微信群→重要信息被刷掉。", short:"200人多职场协同管理框架", relatedIds:[6,14], sourceType:"manual", sourceId:"", version:1, versionHistory:[], status:"published"},

  {id:11, title:"客服质检标准制定与执行指南", domain:"流程与SOP", tags:"质检,标准,评分,闭环", projectId:"", scope:"通用", permission:"公开", fileUrl:"", createdAt:"2026-08-11", updateTime:"2026-08-11", views:0, downloads:0, description:"【适用场景】新建质检体系、或现有标准效果不佳。\n\n【制定三步】1.确定质检维度(5-7个)：问候语(5分)/需求理解(20分)/解决方案(25分)/响应时效(15分)/服务态度(15分)/追加销售(10分)/结束语(10分)，总分100。2.每维度定义三级标准(合格/良好/优秀)并附实例对话，须可衡量。3.试打分：用20条历史对话让人工和AI分别打分，一致性>85%才启用。\n\n【执行闭环】质检→反馈(24h内私聊)→辅导(给改进话术不只说你不行)→复检(3天后复查)→归档(月度汇总纳入绩效)。\n\n【常见坑】标准太复杂质检员不用→控1页纸；只打分不辅导→员工反感质检。", short:"客服质检标准制定到闭环执行", relatedIds:[3,8], sourceType:"manual", sourceId:"", version:1, versionHistory:[], status:"published"},

  {id:12, title:"主流电商平台大促规则速查", domain:"风控与应急", tags:"平台规则,淘宝,京东,拼多多,抖音,大促", projectId:"", scope:"通用", permission:"公开", fileUrl:"", createdAt:"2026-08-11", updateTime:"2026-08-11", views:0, downloads:0, description:"【适用场景】大促前各平台规则集中更新，客服团队需快速掌握。\n\n【平台规则对比】(以2026双11为参考，以平台最新公告为准)\n淘宝/天猫：发货时效延长至15天；价保规则15天内降价可申请补差；未发货秒退款额度临时提升；纠纷率影响店铺权重。\n京东：211限时达可能调为次日达；价保7-15天；自营和POP规则不同要区分。\n拼多多：发货超时罚款加倍；仅退款政策较宽松需防恶意退款。\n抖音：发货时效通常48h内；运费险一般平台赠送；虚拟号码保护影响回访。\n\n【速查流】大促前2周整理规则变更→提炼1页FAQ(每条2行对应1场景)→全员培训考试(80分及格)→贴工位。", short:"淘宝京东拼多多抖音大促规则速查", relatedIds:[9], sourceType:"manual", sourceId:"", version:1, versionHistory:[], status:"published"},

  {id:13, title:"客服数据报表解读指南", domain:"方法论与框架", tags:"数据,报表,解读,决策,KPI", projectId:"", scope:"通用", permission:"公开", fileUrl:"", createdAt:"2026-08-11", updateTime:"2026-08-11", views:0, downloads:0, description:"【适用场景】不知如何从数据报表发现问题时使用。\n\n【核心指标解读】\n1.转化率：下降→查话术/优惠解释/排队时间(不全是客服问题，流量变了也影响)\n2.响应时长：超标→查排班是否合理→还是某客服需辅导\n3.CSAT：<4.5→拉低分会话逐条分析：态度问题or解决不了问题\n4.FCR首次解决率：低→知识储备不足→需培训而非增人手\n5.客单价：忽高忽低→有人强推or消极推荐\n\n【决策路径】看数字→和上周对比→和同类项目对比→找异常→深挖原因→行动→下周验证。\n\n【常见坑】只看总数不看趋势(达标但连续三周下滑要警惕)；把相关性当因果。", short:"从报表数字到管理决策完整路径", relatedIds:[14,11], sourceType:"manual", sourceId:"", version:1, versionHistory:[], status:"published"},

  {id:14, title:"客服团队排班优化实操方法", domain:"人员管理", tags:"排班,班次,高峰,人力", projectId:"", scope:"通用", permission:"公开", fileUrl:"", createdAt:"2026-08-11", updateTime:"2026-08-11", views:0, downloads:0, description:"【适用场景】排班不合理导致高峰爆线、低谷人浮于事。\n\n【三数据驱动】1.取30天数据按小时统计接待量，画一天接待量曲线，标记3个峰值(通常10-12/14-16/20-22)。2.按峰值系数算所需人数=预估接待量÷单人产能×(1+20%缓冲)。3.设计3-4种班次：早班(8-17)、中班(12-21)、晚班(15-24)，每班覆盖1-2峰值。\n\n【优化技巧】新人配老手(每班至少1老员工)；机动班(1-2个10-19随时调配)；换班规则(提前24h申请组长审批)。\n\n【常见坑】排班靠感觉非数据→永远调不准；忽略长期疲劳→离职率升。\n\n【搭配】与人力成本优化模型一起看——好排班是最直接降本手段。", short:"数据驱动的客服排班优化方法", relatedIds:[1,13], sourceType:"manual", sourceId:"", version:1, versionHistory:[], status:"published"}
