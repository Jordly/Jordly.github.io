// ===== Lucide SVG 图标库（精简版 · 2026-08-07）=====
// 在线定制页面：https://lucide.dev/icons/
// 用法：lucideIcon('folder', 18) 返回 18x18 的 SVG 字符串
...
var LUCIDE_PATHS = {
  ...
  'pencil': '<line x1="18" x2="12" y1="2" y2="8"/><line x1="6" x2="2" y1="12" y2="16"/><line x1="22" x2="18" y1="2" y2="6"/><path d="M14.5 21.5H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v4.5"/><path d="M10 15.8V19l-3.2-.8"/>',
...
// 返回 SVG 字符串，默认 18px，color 继承自父元素
function lucideIcon(name, size) {
  size = size || 18;
  var path = LUCIDE_PATHS[name];
  if (!path) {
    // 未找到图标，返回占位
    return '<svg xmlns="http://www.w3.org/2000/svg" width="' + size + '" height="' + size + '" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink:0;"></svg>';
  }
