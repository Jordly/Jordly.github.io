const fs = require('fs');
const filePath = 'C:/Users/OseasyVM/WorkBuddy/2026-05-29-17-12-21/prototype/app.js';

let content = fs.readFileSync(filePath, 'utf8');

// 找到 renderIssue 函数的开始和结束位置
const startMarker = '// ===== 问题与课题协作 =====\n\nfunction renderIssue(){';
const endMarker = '\n}\n\n\n// ===== 核心知识能量池 =====';

const startIndex = content.indexOf(startMarker);
if (startIndex === -1) {
  console.error('找不到函数开始位置');
  process.exit(1);
}
...
console.log('找到函数：开始位置', startIndex, '结束位置', endIndex);

const newFunction = `// ===== 问题与课题协作 =====
...
const newContent = content.substring(0, startIndex) + newFunction + content.substring(endIndex + endMarker.length);
